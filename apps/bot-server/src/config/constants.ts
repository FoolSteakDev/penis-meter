...
/**
 * Коли в когось із учасників value <= 0, ставка обмежена цією фіксованою
 * стелею замість min(value1, value2) - інакше межа була б <= 0 і дуель
 * узагалі не мала б доступної ставки. Рішення власника: доступність дуелі
