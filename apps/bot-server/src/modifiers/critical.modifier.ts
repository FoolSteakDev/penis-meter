...
// Свідомо НЕ інвертуються за змістом для режиму 'drill' (див. 3.7 плану):
// "КРИТИЧНИЙ ПРОВАЛ" разом із від'ємною дельтою (яка для буровика є ПРОГРЕСОМ,
// бо мінус - це успіх) створює комічний ефект, і це фіча, а не баг.
